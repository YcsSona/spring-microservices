...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST APIS to create new Customer & Account inside EazyBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST APIS to update Customer & Account details based on a mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "Delete Account & Customer etails REST API",
            description = "REST APIS to delete Customer & Account details based on a mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
